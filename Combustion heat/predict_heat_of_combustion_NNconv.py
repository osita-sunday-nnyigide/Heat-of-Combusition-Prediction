...
class ChemHazardGNN(nn.Module):
    def __init__(self, node_dim, edge_dim, desc_dim, hidden_dim, out_dim):
        super().__init__()
        ...
        self.conv1 = NNConv(node_dim, hidden_dim, self.edge_network1, aggr='mean')
